...
public class WorldInstancedShader extends Shader {
...
//    private int lightPos;
        ...
        public WorldInstancedShader() {
            super("WorldInstancedShader_vs.glsl", "WorldInstancedShader_fs.glsl");

            bindAttribLocation(0, "position");
            bindAttribLocation(1, "textureCoordinates");
            bindAttribLocation(2, "normal");
            bindAttribLocation(3, "aOffset");
            linkAndValidate();
